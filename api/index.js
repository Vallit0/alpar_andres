...
async function initializeAzureClient() {
  try {
    if (process.env.AZURE_PROJECT_URL && process.env.AZURE_AGENT_ID) {
      ...
      console.log('⚠️ Azure AI Projects not configured, running in demo mode');
    }
  } catch (error) {
...
Para habilitar las funcionalidades completas de IA, necesitarías configurar las variables de entorno de Azure AI Projects.`,
...
**🚀 Próximo paso:** Configurar Azure AI Projects
